...
if (isset($_GET['id'])) {
    ...
    $query = $pdo->query('DELETE FROM alertes WHERE id = ' . $id . ';');
}
...
<html lang="en">
    <head>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/flowbite.min.js"
                defer></script>
        <script src="TotalPrice.js"
                defer></script>
        <script src="DeleteOrder.js"
                defer></script>
        <script src="UpdateOrder.js"
                defer></script>
        <script src="AlertModal.js"
                defer></script>
        <script>
            tailwind.config = {
                darkMode: 'class',
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <button type="button"
                                    ...
                                    class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 transition">
                        ...
                        <div id="modal-alert"
                             class="hidden border rounded absolute right-0 top-16 bg-white px-4 <?php if ($query) {
                                 echo "max-h-80";
                             } ?> overflow-auto">
                            <ul>
                                <?php
                                if (!$query) {
                                    echo '<p class="p-24">Aucune alertes.</p>';
                                }

                                foreach ($query as $item):
                                    ?>
                                    <li id="<?= $item['id'] ?>"
                                        class="py-4 border-b last:border-b-0 flex items-center justify-between gap-24">
                                            <span>
                                                <?= $item['type_alerte'] ?>
                                            </span>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col"
                                        class="px-4 py-4">Nom Produit
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">Quantité
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">Status
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">Fournisseur
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">Date Commande
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">Prix Total
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3">
                                ...
                                foreach ($commandes as $commande):
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="<?= $template_array_id[$i] ?>-button"
                                                    data-dropdown-toggle="<?= $template_array_id[$i] ?>"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        ...
                        <ul class="inline-flex items-stretch -space-x-px">
                            ...
                            <li>
                                <a href="?page=<?= $page ?>"
                                   class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-primary-600 bg-primary-50 border border-primary-300 hover:bg-primary-100 hover:text-primary-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white"><?= $page ?></a>
                            </li>
                            <li>
                                <a href="?page=<?= $page_total["total"] == 10 ? $page + 1 : $page ?>"
                            ...
                            <div>
                                ...
                                <select name="category"
                                    ...
                                    foreach ($produits as $produit) :
                                        ?>
                                        <option data-unit-price="<?= $produit["prix_unitaire"] ?>"
        ...
        <div id="deleteModal"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-300">Êtes-vous sûr de vouloir supprimer cet élément
                        ?</p>
